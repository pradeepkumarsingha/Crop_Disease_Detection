...
# Define paths
project_root = "D:/AI/Crop_disease"
data_dir = os.path.join(project_root, "D:/AI/Crop_disease/clean_data")
img_dir = os.path.join(project_root, "D:/AI/Crop_disease/Crop Disease")
